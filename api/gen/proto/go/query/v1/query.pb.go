...
const (
	...
	QueryType_QUERY_TIME_SERIES_ANALYSIS QueryType = 9
)
...
const (
	...
	ReportType_REPORT_TIME_SERIES_ANALYSIS ReportType = 9
)
...
type Query struct {
	...
	TimeSeriesAnalysis *TimeSeriesAnalysisQuery `protobuf:"bytes,10,opt,name=time_series_analysis,json=timeSeriesAnalysis,proto3" json:"time_series_analysis,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type Report struct {
	...
	TimeSeriesAnalysis *TimeSeriesAnalysisReport `protobuf:"bytes,10,opt,name=time_series_analysis,json=timeSeriesAnalysis,proto3" json:"time_series_analysis,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
type TimeSeriesAnalysisQuery struct {
	...
	GroupBy       []string                      `protobuf:"bytes,2,rep,name=group_by,json=groupBy,proto3" json:"group_by,omitempty"`
	Limit         int64                         `protobuf:"varint,3,opt,name=limit,proto3" json:"limit,omitempty"`
	Config        *v12.TimeSeriesAnalysisConfig `protobuf:"bytes,4,opt,name=config,proto3" json:"config,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TimeSeriesAnalysisQuery) GetConfig() *v12.TimeSeriesAnalysisConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
type TimeSeriesAnalysisReport struct {
	...
	TimeSeries    []*v11.Series          `protobuf:"bytes,2,rep,name=time_series,json=timeSeries,proto3" json:"time_series,omitempty"`
	Events        []*v12.TimeSeriesEvent `protobuf:"bytes,3,rep,name=events,proto3" json:"events,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TimeSeriesAnalysisReport) GetEvents() []*v12.TimeSeriesEvent {
	if x != nil {
		return x.Events
	}
	return nil
...
const file_query_v1_query_proto_rawDesc = "" +
	...
	"\x13time_series_compact\x18\t \x01(\v2\x19.query.v1.TimeSeriesQueryR\x11timeSeriesCompact\x12S\n" +
	"\x14time_series_analysis\x18\n" +
	" \x01(\v2!.query.v1.TimeSeriesAnalysisQueryR\x12timeSeriesAnalysis\"u\n" +
	...
	"\x10compaction_level\x18\a \x01(\rR\x0fcompactionLevel\"\xef\x04\n" +
	"\x06Report\x125\n" +
	...
	"\x13time_series_compact\x18\t \x01(\v2!.query.v1.TimeSeriesCompactReportR\x11timeSeriesCompact\x12T\n" +
	"\x14time_series_analysis\x18\n" +
	" \x01(\v2\".query.v1.TimeSeriesAnalysisReportR\x12timeSeriesAnalysis\"\x11\n" +
	...
	"\bgroup_by\x18\x02 \x03(\tR\agroupBy\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\x03R\x05limit\x12<\n" +
	"\x06config\x18\x04 \x01(\v2$.querier.v1.TimeSeriesAnalysisConfigR\x06config\"\xbb\x01\n" +
	"\x18TimeSeriesAnalysisReport\x127\n" +
	"\x05query\x18\x01 \x01(\v2!.query.v1.TimeSeriesAnalysisQueryR\x05query\x121\n" +
	"\vtime_series\x18\x02 \x03(\v2\x10.types.v1.SeriesR\n" +
	"timeSeries\x123\n" +
	"\x06events\x18\x03 \x03(\v2\x1b.querier.v1.TimeSeriesEventR\x06events\"\xba\x02\n" +
	"\tTreeQuery\x12\x1b\n" +
	...
	"timeSeries\x12A\n" +
	"\x0fattribute_table\x18\x03 \x01(\v2\x18.query.v1.AttributeTableR\x0eattributeTable*\xf4\x01\n" +
	"\tQueryType\x12\x15\n" +
	...
	"\x19QUERY_TIME_SERIES_COMPACT\x10\b\x12\x1e\n" +
	"\x1aQUERY_TIME_SERIES_ANALYSIS\x10\t*\xff\x01\n" +
	"\n" +
	"ReportType\x12\x16\n" +
	...
	"\x1aREPORT_TIME_SERIES_COMPACT\x10\b\x12\x1f\n" +
	"\x1bREPORT_TIME_SERIES_ANALYSIS\x10\t2R\n" +
...
var file_query_v1_query_proto_goTypes = []any{
	...
	(*TimeSeriesAnalysisQuery)(nil),      // 24: query.v1.TimeSeriesAnalysisQuery
	(*TimeSeriesAnalysisReport)(nil),     // 25: query.v1.TimeSeriesAnalysisReport
	...
	(*v12.TimeSeriesAnalysisConfig)(nil), // 44: querier.v1.TimeSeriesAnalysisConfig
	(*v12.TimeSeriesEvent)(nil),          // 45: querier.v1.TimeSeriesEvent
	(*v11.StackTraceSelector)(nil),       // 46: types.v1.StackTraceSelector
	(*v13.Mapping)(nil),                  // 47: google.v1.Mapping
	(*v13.Location)(nil),                 // 48: google.v1.Location
	(*v13.Function)(nil),                 // 49: google.v1.Function
	(v12.HeatmapQueryType)(0),            // 50: querier.v1.HeatmapQueryType
}
var file_query_v1_query_proto_depIdxs = []int32{
	...
	24, // 18: query.v1.Query.time_series_analysis:type_name -> query.v1.TimeSeriesAnalysisQuery
	...
	28, // 32: query.v1.Report.tree:type_name -> query.v1.TreeReport
	30, // 33: query.v1.Report.pprof:type_name -> query.v1.PprofReport
	35, // 34: query.v1.Report.heatmap:type_name -> query.v1.HeatmapReport
	39, // 35: query.v1.Report.time_series_compact:type_name -> query.v1.TimeSeriesCompactReport
	25, // 36: query.v1.Report.time_series_analysis:type_name -> query.v1.TimeSeriesAnalysisReport
	...
	44, // 44: query.v1.TimeSeriesAnalysisQuery.config:type_name -> querier.v1.TimeSeriesAnalysisConfig
	24, // 45: query.v1.TimeSeriesAnalysisReport.query:type_name -> query.v1.TimeSeriesAnalysisQuery
	43, // 46: query.v1.TimeSeriesAnalysisReport.time_series:type_name -> types.v1.Series
	45, // 47: query.v1.TimeSeriesAnalysisReport.events:type_name -> querier.v1.TimeSeriesEvent
	46, // 48: query.v1.TreeQuery.stack_trace_selector:type_name -> types.v1.StackTraceSelector
	47, // 49: query.v1.TreeSymbols.mappings:type_name -> google.v1.Mapping
	48, // 50: query.v1.TreeSymbols.locations:type_name -> google.v1.Location
	49, // 51: query.v1.TreeSymbols.functions:type_name -> google.v1.Function
	26, // 52: query.v1.TreeReport.query:type_name -> query.v1.TreeQuery
	27, // 53: query.v1.TreeReport.symbols:type_name -> query.v1.TreeSymbols
	46, // 54: query.v1.PprofQuery.stack_trace_selector:type_name -> types.v1.StackTraceSelector
	29, // 55: query.v1.PprofReport.query:type_name -> query.v1.PprofQuery
	50, // 56: query.v1.HeatmapQuery.query_type:type_name -> querier.v1.HeatmapQueryType
	42, // 57: query.v1.HeatmapQuery.exemplar_type:type_name -> types.v1.ExemplarType
	33, // 58: query.v1.HeatmapSeries.points:type_name -> query.v1.HeatmapPoint
	31, // 59: query.v1.HeatmapReport.query:type_name -> query.v1.HeatmapQuery
	34, // 60: query.v1.HeatmapReport.heatmap_series:type_name -> query.v1.HeatmapSeries
	32, // 61: query.v1.HeatmapReport.attribute_table:type_name -> query.v1.AttributeTable
	36, // 62: query.v1.Point.exemplars:type_name -> query.v1.Exemplar
	37, // 63: query.v1.Series.points:type_name -> query.v1.Point
	22, // 64: query.v1.TimeSeriesCompactReport.query:type_name -> query.v1.TimeSeriesQuery
	38, // 65: query.v1.TimeSeriesCompactReport.time_series:type_name -> query.v1.Series
	32, // 66: query.v1.TimeSeriesCompactReport.attribute_table:type_name -> query.v1.AttributeTable
